<template>
  <BaseWrapper title="Experiment Settings" :gray-dark="modes.development" :green="modes.sandbox" :red="modes.production">
    <div class="Container">
      <BaseInput v-for="(item,i) in items" :key="i" :label="item.name || item" :value="item.value" @keyPress="handleKeyPress" />
